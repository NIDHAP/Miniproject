								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Package (Short)</label>
												<div class="col-sm-8">
...
<div class="form-group">
									<label class="col-sm-2 control-label">Package (Full)</label>
									<div class="col-sm-8">
									<input type="text" class="form-control" name="cnf" value="" >
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Add package">
												</div>
											</div>
