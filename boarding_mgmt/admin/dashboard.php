...
?>
													...
													<div class="stat-panel-title text-uppercase">Total Packages</div>
												</div>
											</div>
											<a href="manage-packages.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
<style> .foot{text-align: center; border: 1px solid black;margin-top: 250px;}</style>
